...
- 🧰 **会自己干活的职业系统** —— 把工具丢进它的背包,切到「自由活动」,它就开始替你忙活:**农夫**种田收割、**剑士**近战御敌、**弓手**远程压制、**乐师**为你演奏。
...
- ⚔️ **角色武器** —— 原作里的「吉伊的刺叉」「小八的刺叉」「乌萨奇的讨伐棒」可合成;「獭师父的剑」只有野生的獭师父带着。
...
- **跟随** —— 小可爱跟着你跑。
- **坐下** —— 待在原地不动。
- **自由活动** —— 在你设定的位置附近开始执行它的职业。

### 💼 职业
一只宠物干什么活,**由它手持的工具决定**。空手右键打开背包,把工具放进去,再切到「自由活动」:

| 职业 | 给它…… | 它会做什么 |
| --- | --- | --- |
| **农夫 Farmer** | 一把锄头 | 自动种植并收割附近的作物(支持模组种子) |
| **剑士 Fencer** | 一把剑(或角色自己的武器) | 近战攻击附近的敌对生物 |
| **弓手 Archer** | 一把弓(背包里要有箭) | 远程射击敌对生物 |
| **乐师 Musician** | 一台音乐盒 | 演奏你导入的音乐 |

> 宠物只在「自由活动」下战斗/干活;跟随和坐下时它们乖乖的、不会主动出击。
>
...
### 🎁 怎么获得物品
- **武器**(刺叉、讨伐棒)可**合成** —— 翻翻配方书(羊毛 + 木棍 + 燧石)。獭师父的剑不行。
- **音乐盒**也可**合成**(音符盒 + 木板 + 金锭)。
