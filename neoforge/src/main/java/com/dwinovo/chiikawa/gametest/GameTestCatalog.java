...
public final class GameTestCatalog {
    ...
    private static void registerTests(RegisterGameTestsEvent event) {
        // The cases go in while the registries are being loaded. A dedicated server that is
        // already starting is handed the event once more, over the same registries frozen by
        // then, with the cases in them already.
