 ...
 * there on either loader. Forge runs biome modifiers when the server starts, after the
...
public final class PetSpawnsBiomeModifier implements BiomeModifier {
    ...
    public static final Codec<PetSpawnsBiomeModifier> CODEC = Codec.unit(INSTANCE);
