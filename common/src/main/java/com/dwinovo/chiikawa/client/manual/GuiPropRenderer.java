...
public final class GuiPropRenderer extends PictureInPictureRenderer<GuiPropRenderer.State> {
    ...
    public GuiPropRenderer(MultiBufferSource.BufferSource bufferSource) {
        super(bufferSource);
    }
    ...
    protected void renderToTexture(State state, PoseStack pose) {
        ...
        PropRenderer.draw(state.prop(), pose, features.getSubmitNodeStorage(), LightCoordsUtil.FULL_BRIGHT,
