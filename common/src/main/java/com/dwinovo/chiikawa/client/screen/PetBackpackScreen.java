...
public class PetBackpackScreen extends AbstractContainerScreen<PetBackpackMenu> {
    ...
    protected void renderBg(GuiGraphics graphics, float partialTick, int mouseX, int mouseY) {
        ...
        if (pet != null) {
            ...
            int x1 = this.leftPos + PORTRAIT_X + UiStyle.BORDER;
            int y1 = this.topPos + PORTRAIT_Y + UiStyle.BORDER;
            int x2 = this.leftPos + PORTRAIT_X + PORTRAIT_W - UiStyle.BORDER;
            int y2 = this.topPos + PORTRAIT_Y + PORTRAIT_H - UiStyle.BORDER;
