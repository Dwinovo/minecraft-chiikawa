 ...
 * the same state {@link com.dwinovo.chiikawa.anim.render.ModelRenderer} sees
 * when it walks the main mesh.
 *
 * <p>The pose buffer is the post-interceptor flat array (rot/pos/scale per
 * bone) that {@link com.dwinovo.chiikawa.anim.runtime.PoseSampler} produced
 ...
 * @param bufferSource  vertex buffer source for any geometry the layer emits
