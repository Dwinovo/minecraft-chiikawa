...
public final class BedrockResourceLoader implements ResourceManagerReloadListener {
    ...
    public void onResourceManagerReload(ResourceManager manager) {
        ...
        Map<Identifier, List<ParallelTrack>> parallelByModel = loadParallelTracks(manager);
        Map<Identifier, BakedModel> bakedModels = loadModels(manager, parallelByModel, stamp);
    ...
    private static Map<Identifier, BakedModel> loadModels(ResourceManager manager,
                                                          Map<Identifier, List<ParallelTrack>> parallelByModel,
                                                          long stamp) {
     ...
     */
    private static Map<Identifier, List<ParallelTrack>> loadParallelTracks(ResourceManager manager) {
        Map<Identifier, List<ParallelTrack>> result = new HashMap<>();
