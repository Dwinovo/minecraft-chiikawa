...
public final class InitItems {
    ...
    public static final Supplier<Item> RAKKO_SWORD =
        registerItem("rakko_sword", RakkoSword::new);
    ...
    public static final Supplier<Item> SIMPLE_DISH =
        registerItem("simple_dish", Item::new);
     ...
     * the labor board, the shop, the handbook and the pets' weapons. Each loader registers the special model renderer
     * their item definitions name, and their item models are generated from this list.
     */
