...
public final class InitMemory {
    ...
    public static final Supplier<MemoryModuleType<Map<Identifier, Long>>> INTENT_COOLDOWNS =
        Services.REGISTRY.<MemoryModuleType<Map<Identifier, Long>>>register(
            BuiltInRegistries.MEMORY_MODULE_TYPE,
            Identifier.fromNamespaceAndPath(Constants.MOD_ID, "intent_cooldowns"),
            () -> new MemoryModuleType<>(Optional.empty())
        );
