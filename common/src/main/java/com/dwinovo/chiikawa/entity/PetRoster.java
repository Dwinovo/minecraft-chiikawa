...
public class PetRoster extends SavedData {
    ...
    static final Codec<PetRoster> CODEC = Owner.CODEC.listOf().fieldOf("Owners")
        .xmap(PetRoster::fromOwners, PetRoster::toOwners).codec();
    /** Saved as-is: nothing in it for the game's data fixers to upgrade. */
    private static final SavedDataType<PetRoster> TYPE =
        new SavedDataType<>(Identifier.withDefaultNamespace(FILE), PetRoster::new, CODEC, null);
    ...
    private static PetRoster fromOwners(List<Owner> owners) {
