...
public class KurimanjuPet extends AbstractPet {

    public KurimanjuPet(EntityType<? extends TamableAnimal> entityType, Level level) {
    ...
    protected PetSoundSet getSoundSet() {
        return PetSoundSets.KURIMANJU;
    }

    @Override
    protected Item getReviveDollItem() {
        return InitItems.KURIMANJU_DOLL.get();
    }
}
