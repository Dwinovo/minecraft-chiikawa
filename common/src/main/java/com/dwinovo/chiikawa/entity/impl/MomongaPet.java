...
public class MomongaPet extends AbstractPet {

    public MomongaPet(EntityType<? extends TamableAnimal> entityType, Level level) {
    ...
    protected PetSoundSet getSoundSet() {
        return PetSoundSets.MOMONGA;
    }

    @Override
    protected Item getReviveDollItem() {
        return InitItems.MOMONGA_DOLL.get();
    }
}
