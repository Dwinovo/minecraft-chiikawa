...
public class MusicBoxItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (selection == null) {
            tooltip.add(Component.translatable("tooltip.chiikawa.music_box.empty").withStyle(ChatFormatting.GRAY));
        } else {
            tooltip.add(Component.translatable("tooltip.chiikawa.music_box.selected", selection.title()).withStyle(ChatFormatting.AQUA));
        }
    }
}
