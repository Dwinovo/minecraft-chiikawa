...
public final class PetInteractions {
    private static volatile SortedMap<Identifier, PetInteraction> byId = Collections.emptySortedMap();
    ...
    public static SortedMap<Identifier, PetInteraction> all() {
        return byId;
    }

    static void replaceAll(Map<Identifier, PetInteraction> interactions) {
