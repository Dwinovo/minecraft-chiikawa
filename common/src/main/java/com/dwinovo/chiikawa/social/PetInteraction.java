...
public record PetInteraction(
    ...
    public static final Codec<PetInteraction> CODEC = RecordCodecBuilder.create(instance -> instance.group(
        ...
        ExtraCodecs.strictOptionalField(PartnerState.CODEC, "partner_state", PartnerState.IDLE).forGetter(PetInteraction::partnerState),
        ExtraCodecs.strictOptionalField(SlipCondition.CODEC, "partner_finished").forGetter(PetInteraction::partnerFinished),
        ExtraCodecs.strictOptionalField(ExtraCodecs.TAG_OR_ELEMENT_ID, "hands_over").forGetter(PetInteraction::handsOver),
        ExtraCodecs.strictOptionalField(ExtraCodecs.NON_NEGATIVE_INT, "partner_eager_ticks", 0).forGetter(PetInteraction::partnerEagerTicks),
    ...
    public record Side(
        ...
        public static final Codec<Side> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            ExtraCodecs.strictOptionalField(Codec.STRING, "pose").forGetter(Side::pose),
            ExtraCodecs.strictOptionalField(Beat.CODEC, "begin").forGetter(Side::begin),
            ExtraCodecs.strictOptionalField(Beat.Recurring.CODEC, "now_and_then").forGetter(Side::nowAndThen),
            ExtraCodecs.strictOptionalField(Beat.CODEC, "end").forGetter(Side::end)
