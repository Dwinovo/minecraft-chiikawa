...
public final class TagData {
    ...
    public static void addEntityTags(TagAppenderProvider<EntityType<?>> tags) {
        ...
        tags.tag(InitTag.ENTITY_HOSTILE_ENTITY)
            ...
            .add(key(EntityTypes.ZOMBIE_VILLAGER));
    }
}
