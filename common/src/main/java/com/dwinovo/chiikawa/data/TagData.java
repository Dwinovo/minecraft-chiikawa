...
public final class TagData {
    ...
    public static void addEntityTags(TagAppenderProvider<EntityType<?>> tags) {
        ...
        // it, and an archer can answer one from outside the blast. (1.20.4 has no bogged
        // yet.)
        tags.add(InitTag.ENTITY_HOSTILE_ENTITY,
            EntityType.BLAZE, EntityType.BREEZE, EntityType.CAVE_SPIDER, EntityType.CREEPER,
